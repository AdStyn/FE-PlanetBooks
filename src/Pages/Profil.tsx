    ...
    <div className="mt-12">
      <div className="flex items-center justify-center h-screen bg-white">
        ...
        <div className="flex flex-col items-center">
          ...
          <button onClick={()=>setIsModalOpen(true)} className="translate-x-12 bg-blue-900 text-white py-3 px-3 rounded-full -translate-y-16">
          <MdEdit />
          </button>
          {IsModalOpen &&
        <SectionSetting user={userData}/>}
          ...
          <button className="bg-blue-900 text-white py-4 px-6 rounded-full mr-16"
          onClick={() => window.location.assign("/Layout")}
          >
            Back    
          </button>
          {localStorage.getItem("token") ? ( // Check if token exists (user logged in)
  <button
